...
class PathProviderPi extends PathProviderPlatform {
  /// Constructs an instance of [PathProviderLinux]
  PathProviderPi() : _environment = Platform.environment;

  /// Constructs an instance of [PathProviderLinux] with the given [environment]
  @visibleForTesting
  PathProviderPi.private(
  ...
  static void registerWith() {
    PathProviderPlatform.instance = PathProviderPi();
  }
